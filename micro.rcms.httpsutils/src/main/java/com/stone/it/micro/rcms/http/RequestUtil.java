...
public class RequestUtil extends RequestExecute {
    ...
    public static ResponseEntity doGet(String url, Map<String, String> params, Map<String, String> header) throws Exception {
    ...
    public static ResponseEntity doPost(HttpClient httpClient, String url, String body, Map<String, String> header) throws Exception {
    ...
    public static ResponseEntity doDelete(HttpClient client, String url, String body, Map<String, String> header) throws Exception {
