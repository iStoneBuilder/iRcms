...
VALUES (0,100000000000, 'RCMS平台','8888888888888', 1,'platform', 1,'RCMS', '', '', '', NOW(), 'system',NOW(),'system');
-- 初始化平台账户数据
...
VALUES (100000000000, 'superAdmin', '超级管理员', 'user', 'e10adc3949ba59abbe56e057f20f883e', 'platformAdmin', NOW(), 'system',NOW(),'system');
-- 初始化平台角色数据
INSERT INTO `tpl_role_t` (`enterprise_id`,`parent_id`, `id`, `code`, `name`, `description`, `CREATED_TIME`, `CREATED_BY`, `UPDATED_TIME`, `UPDATED_BY`)
VALUES (100000000000, 0, 10000, 'platformAdmin', '平台管理员', '平台管理员角色', NOW(), 'system',NOW(),'system');