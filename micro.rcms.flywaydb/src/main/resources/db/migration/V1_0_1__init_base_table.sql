-- base 功能不屈服企租
--  国际化信息
CREATE TABLE IF NOT EXISTS `tpl_fram_i18n_t`(
...
-- LOOK UP CLASSIFY
CREATE TABLE IF NOT EXISTS `tpl_fram_classify_t`(
...
-- LOOK UP ITEM
CREATE TABLE IF NOT EXISTS `tpl_fram_item_t`(
    `CLASSIFY_CODE`    VARCHAR(200) NOT NULL COMMENT 'CLASSIFY_CODE',
...
-- 栏目表
CREATE TABLE IF NOT EXISTS `tpl_fram_menu_t`(
